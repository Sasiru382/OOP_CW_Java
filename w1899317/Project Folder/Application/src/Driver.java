...
public class Driver extends JFrame{
    ...
    public Driver(){
        ...
        JLabel footer1 = new JLabel("Address : 24/4 Wijerathna road Katukurunda Kalutara");
        footer1.setBorder(new EmptyBorder(30,0,30,30));
        JLabel footer2 = new JLabel("Contact no: 077 9999999");
        footer2.setBorder(new EmptyBorder(30,20,30,20));
        JLabel footer3 = new JLabel("Email : BestSkinConsultation@gamil.com");
